...
class PreprocessorReader < Reader
  ...
  def initialize document, data = nil, cursor = nil, opts = {}
    @document = document
    opts = opts.merge skip_front_matter: true if document.attributes['skip-front-matter']
  ...
  def push_include data, file = nil, path = nil, lineno = 1, attributes = {}
    ...
    if (@lines = prepare_lines data, normalize: true, condense: false, indent: attributes['indent'], skip_front_matter: attributes['skip-front-matter-option']).empty?
      pop_include
    else
