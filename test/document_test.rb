...
Getting Real details the business, design, programming, and marketing principles of 37signals.
      ...
      assert_equal 'david@37signals.com', doc.authors[0].email
      assert_equal 'David Heinemeier Hansson', doc.authors[0].name
      assert_equal 'David', doc.authors[0].firstname
      assert_equal 'Heinemeier', doc.authors[0].middlename
      assert_equal 'Hansson', doc.authors[0].lastname
      assert_equal 'DHH', doc.authors[0].initials
    end
...
Getting Real details the business, design, programming, and marketing principles of 37signals.
      ...
      doc = document_from_string input
      assert_equal 2, doc.authors.size
      assert_equal 'david@37signals.com', doc.authors[0].email
      assert_equal 'David Heinemeier Hansson', doc.authors[0].name
      assert_equal 'David', doc.authors[0].firstname
      assert_equal 'Heinemeier', doc.authors[0].middlename
      assert_equal 'Hansson', doc.authors[0].lastname
      assert_equal 'DHH', doc.authors[0].initials
      assert_equal 'jason@37signals.com', doc.authors[1].email
      assert_equal 'Jason Fried', doc.authors[1].name
      assert_equal 'Jason', doc.authors[1].firstname
      assert_equal nil, doc.authors[1].middlename
      assert_equal 'Fried', doc.authors[1].lastname
      assert_equal 'JF', doc.authors[1].initials
    end
