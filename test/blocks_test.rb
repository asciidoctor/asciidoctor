...
You can use icons for admonitions by setting the 'icons' attribute.
      ...
      output = render_string input, :safe => Asciidoctor::SafeMode::SERVER
      assert_css 'html > head > link[rel="stylesheet"][href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.6.1/css/font-awesome.min.css"]', output, 1
...
puts "AsciiDoc, FTW!"
      ...
      assert_css 'html > head > link[rel="stylesheet"][href="http://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.6.1/css/font-awesome.min.css"]', output, 1
...
puts "AsciiDoc, FTW!"
      ...
      output = render_string input, :safe => Asciidoctor::SafeMode::SAFE
      assert_css 'html > head > link[rel="stylesheet"][href="//cdnjs.cloudflare.com/ajax/libs/font-awesome/4.6.1/css/font-awesome.min.css"]', output, 1
