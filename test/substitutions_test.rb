...
context 'Substitutions' do
  ...
  context 'Macros' do
    ...
    test 'an icon macro should be interpreted as a font-based icon when icons=font' do
      ...
      assert_equal %{<span class="fa"><i class="fa fa-github"></i></span>}, para.sub_macros(para.source).gsub(/>\s+</, '><')
    end
    ...
    test 'an icon macro with a size should be interpreted as a font-based icon with a size when icons=font' do
      ...
      assert_equal %{<span class="fa"><i class="fa fa-github fa-4x"></i></span>}, para.sub_macros(para.source).gsub(/>\s+</, '><')
    end
    ...
    test 'an icon macro with a role and title should be interpreted as a font-based icon with a class and title when icons=font' do
      ...
      assert_equal %{<span class="fa red"><i class="fa fa-heart" title="Heart me"></i></span>}, para.sub_macros(para.source).gsub(/>\s+</, '><')
    end
