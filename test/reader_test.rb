...
class ReaderTest < Minitest::Test
  ...
  context 'PreprocessorReader' do
    ...
    context 'Conditional Inclusions' do
      ...
      test 'should log warning if endif is mismatched' do
        ...
        using_memory_logger do |logger|
          ...
          assert_messages logger, [
            ...
            [:ERROR, '~<stdin>: line 3: end of document reached with unterminated preprocessor conditional directive: ifdef::on-quest[]', Hash],
          ]
        end
      end
      ...
      test 'should log warning if endif contains text' do
        ...
        using_memory_logger do |logger|
          ...
          assert_messages logger, [
            ...
            [:ERROR, '~<stdin>: line 4: end of document reached with unterminated preprocessor conditional directive: ifdef::on-quest[]', Hash],
          ]
        end
      end
      ...
      test 'should warn if preprocessor conditional directive is unterminated' do
        input = <<~'EOS'
        before
        ifdef::not-set[]
        skip
        ...
        using_memory_logger do |logger|
          ...
          assert_message logger, :ERROR, '~<stdin>: line 6: end of document reached with unterminated preprocessor conditional directive: ifdef::not-set[]', Hash
        end
      end

      test 'should warn if multiple preprocessor conditional directives are unterminated' do
        input = <<~'EOS'
        before
        ifdef::not-set[]
        skip
        ...
        using_memory_logger do |logger|
          ...
          assert_equal 'before', (lines * Asciidoctor::LF)
          assert_messages logger, [
            [:ERROR, '~<stdin>: line 8: end of document reached with unterminated preprocessor conditional directive: ifdef::not-set[]', Hash],
            [:ERROR, '~<stdin>: line 8: end of document reached with unterminated preprocessor conditional directive: ifeval::[1 == 2]', Hash],
          ]
        end
      end
