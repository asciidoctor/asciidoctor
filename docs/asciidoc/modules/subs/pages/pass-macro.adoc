...
[source]
----
include::{examplesdir}/pass.adoc[tag=3p]
----
...
[source]
----
include::{examplesdir}/pass.adoc[tag=in-macro]
----
...
....
include::{examplesdir}/pass.adoc[tag=sub-in]
....
...
====
include::{examplesdir}/pass.adoc[tag=sub-out]
====
