...
The titles of xref:special.adoc[special sections], such as the Dedication and Colophon, can be turned off by assigning `untitled` to the section's options attribute.
