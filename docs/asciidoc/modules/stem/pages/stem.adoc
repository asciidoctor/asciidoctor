...
:stem:
// um anchor: stem
// stem.adoc, used in user manual: Equations and Formulas
...
Thanks to MathJax JavaScript library, Asciidoctor supports both {url-asciimath}[AsciiMathML^] and {url-latexmath}[TeX and LaTeX^] math notation in the same document.
...
[source]
----
include::{examplesdir}/stem.adoc[tag=base-co]
----
...
[source]
----
include::{examplesdir}/stem.adoc[tag=base-alt]
----
...
[source]
----
include::{examplesdir}/stem.adoc[tag=in-co]
----
...
====
include::{examplesdir}/stem.adoc[tag=in]
====
...
[source]
----
include::{examplesdir}/stem.adoc[tag=bl-co]
----
...
====
include::{examplesdir}/stem.adoc[tag=bl]
====
...
[source]
----
include::{examplesdir}/stem.adoc[tag=multi-l]
----
...
[source]
----
include::{examplesdir}/stem.adoc[tag=multi-a]
----
...
//{url-org}/asciidoctor-fopub[fopub]
