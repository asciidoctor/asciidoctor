...
[source]
----
include::{examplesdir}/title.adoc[tag=base]
----
...
[source]
----
include::{examplesdir}/title.adoc[tag=doc]
----
...
[source]
----
include::{examplesdir}/title.adoc[tag=sub-1]
----
...
[source]
----
include::{examplesdir}/title.adoc[tag=sub-2]
----
...
[source]
----
include::{examplesdir}/title.adoc[tag=sub-3]
----
