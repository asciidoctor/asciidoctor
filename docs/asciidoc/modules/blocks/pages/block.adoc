...
[source]
----
include::{examplesdir}/block.adoc[tag=list-title]
----
...
[source]
----
include::{examplesdir}/block.adoc[tag=meta-co]
----
...
[source]
....
include::{examplesdir}/block.adoc[tag=opt-listing]
....
...
[source]
----
include::{examplesdir}/block.adoc[tag=quote-name]
----
