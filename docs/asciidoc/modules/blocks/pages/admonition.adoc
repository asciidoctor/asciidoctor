...
[source]
----
include::{examplesdir}/admonition.adoc[tag=para-c]
----
...
====
include::{examplesdir}/admonition.adoc[tag=para]
====
// end::icon[]
:icons: font
...
[source]
----
include::{examplesdir}/admonition.adoc[tag=bl-c]
----
...
====
include::{examplesdir}/admonition.adoc[tag=bl-nest]
====
:icons: font
...
Learn more about using Font Awesome or custom icons with admonitions in the xref:macros:icon.adoc[icons section].
