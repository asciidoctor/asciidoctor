...
// include-directive.adoc, included in user-manual
...
To learn more about secure mode, refer to xref:asciidoctor::safe-modes.adoc[Run Asciidoctor Securely with Safe Modes].
