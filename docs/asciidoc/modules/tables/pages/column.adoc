= Table Columns
// table-cols.adoc, included in um: tables: columns
...
[source]
----
include::{examplesdir}/column.adoc[tag=2col-alt]
----
...
[source]
----
include::{examplesdir}/column.adoc[tag=2col]
----
...
----
[cols="3*^"]
include::{examplesdir}/table.adoc[tag=base]
----
...
----
[cols=".<2,.^5,^.>3"]
include::{examplesdir}/column.adoc[tag=base-xtr]
----
...
----
[cols="h,m,s,e"]
include::{examplesdir}/column.adoc[tag=4col]
----
