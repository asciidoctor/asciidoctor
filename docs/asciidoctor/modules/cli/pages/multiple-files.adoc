...
CAUTION: If you process multiple nested AsciiDoc files at once and are also applying a custom stylesheet to them, you'll need to xref:publish:apply-theme.adoc#style-nested[manage the stylesheet's location].
