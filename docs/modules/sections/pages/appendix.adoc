...
////
anchor from user manual: user-appendix
Included in:
- user-manual
////
...
[source]
----
include::{partialsdir}/ex-appendix.adoc[tag=appx-article]
----
...
[source]
----
include::{partialsdir}/ex-appendix.adoc[tag=appx-article-out]
----
...
[source]
----
include::{partialsdir}/ex-appendix.adoc[tag=appx-book]
----
...
[source]
----
include::{partialsdir}/ex-appendix.adoc[tag=appx-book-out]
----
