...
[source]
----
include::{partialsdir}/ex-section.adoc[tag=base]
----

.Render section titles
====
include::{partialsdir}/ex-section.adoc[tag=b-base]
====
...
[source]
----
include::{partialsdir}/ex-section.adoc[tag=bad]
----
...
[source]
----
include::{partialsdir}/ex-section.adoc[tag=content]
----
