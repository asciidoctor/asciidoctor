...
[source]
----
include::{partialsdir}/ex-section.adoc[tag=num-off]
----
...
[source]
----
include::{partialsdir}/ex-section.adoc[tag=num]
----
...
[source]
----
include::{partialsdir}/ex-section.adoc[tag=num-out]
----
...
[source]
----
include::{partialsdir}/ex-section.adoc[tag=sectnuml]
----
