...
You can also set the xref:api:set-safe-mode.adoc[safe mode from the API] and xref:attributes:safe-modes.adoc#set-safe-attrs[manage attributes by safe mode].
