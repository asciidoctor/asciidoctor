...
[source]
----
include::{examplesdir}/pass.adoc[tag=pass-style]
----
...
[source]
----
include::{examplesdir}/pass.adoc[tag=bl]
----
...
[source]
----
include::{examplesdir}/pass.adoc[tag=subs-bl]
----
...
[source]
----
include::{examplesdir}/pass.adoc[tag=no-para]
----
