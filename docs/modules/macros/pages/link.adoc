...
[source]
----
include::{partialsdir}/ex-url.adoc[tag=base-co]
----
...
[source]
----
include::{partialsdir}/ex-url.adoc[tag=irc]
----
// end::basic[]
...
[source]
----
include::{partialsdir}/ex-url.adoc[tag=text]
----

.Rendered URLs
====
include::{partialsdir}/ex-url.adoc[tag=base]
====
...
[source]
----
include::{partialsdir}/ex-url.adoc[tag=unconstrained]
----
...
[source]
----
include::{partialsdir}/ex-url.adoc[tag=linkattrs-h]
----

====
include::{partialsdir}/ex-url.adoc[tag=linkattrs]
====
...
[source]
----
include::{partialsdir}/ex-url.adoc[tag=linkattrs-s]
----
...
[source]
----
include::{partialsdir}/ex-url.adoc[tag=css]
----
