...
[source]
----
include::{examplesdir}/video.adoc[tag=base]
----
...
[source]
----
include::{examplesdir}/video.adoc[tag=attr]
----
...
[source]
----
include::{examplesdir}/video.adoc[tag=caption]
----
...
[source]
----
include::{examplesdir}/video.adoc[tag=you]
----

.Embed a Vimeo video
[source]
----
include::{examplesdir}/video.adoc[tag=vim]
----
