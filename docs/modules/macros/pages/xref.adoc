...
Refer to xref:sections:ids.adoc#auto-id[auto-generated IDs] for more information about how Asciidoctor generates these IDs.
...
[source]
----
include::{partialsdir}/ex-xref.adoc[tag=base]
----
...
[source]
----
include::{partialsdir}/ex-xref.adoc[tag=xref-title]
----
...
[source]
----
include::{partialsdir}/ex-xref.adoc[tag=text]
----
...
[source]
----
include::{partialsdir}/ex-xref.adoc[tag=xref-macro]
----
