...
If you require more advanced theming, you can inject additional resources using a #docinfo-file,docinfo file# or a xref:api:postprocessor.adoc[postprocessor extension].
...
See xref:include:indent.adoc[normalize block indentation] for more detail.
|===
