...
From include-lines-tags.adoc, included in:
- User manual
////
...
[source,ruby]
----
include::{partialsdir}/ex-include.adoc[tag=tag-co]
----
...
[source]
....
include::{partialsdir}/ex-include.adoc[tag=target-co]
....
...
[source]
....
include::{partialsdir}/ex-include.adoc[tag=target-co-multiple]
....
...
[source]
----
include::{partialsdir}/ex-include.adoc[tag=line]
----
...
[source]
----
include::{partialsdir}/ex-include.adoc[tag=m-line-comma]
----
...
[source]
----
include::{partialsdir}/ex-include.adoc[tag=m-line]
----
...
[source]
----
include::{partialsdir}/ex-include.adoc[tag=last]
----
