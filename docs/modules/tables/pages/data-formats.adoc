...
:url-rfc: http://tools.ietf.org/html/rfc4180
////
From table-formats.adoc, included in:
- user-manual: tables
////
...
CSV and TSV both use a delimiter and an optional enclosing character, loosely based on {url-rfc}[RFC 4180].
...
[source]
----
include::{partialsdir}/ex-table-data.adoc[tag=csv]
----
...
// <<user-manual#include-directive,include directive>>
...
[source]
----
include::{partialsdir}/ex-table-data.adoc[tag=dsv]
----
...
Table data in either CSV or TSV format is parsed according to the following rules, loosely based on {url-rfc}[RFC 4180]:
...
[source]
----
include::{partialsdir}/ex-table-data.adoc[tag=s-csv]
----
...
[source]
----
include::{partialsdir}/ex-table-data.adoc[tag=s-dsv]
----
