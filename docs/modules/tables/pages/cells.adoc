...
////
From table-cell.adoc, included in:
...
[source]
----
include::{partialsdir}/ex-table-cell.adoc[tag=3dup]
----
...
[source]
----
include::{partialsdir}/ex-table-cell.adoc[tag=3span]
----
...
[source]
----
include::{partialsdir}/ex-table-cell.adoc[tag=2span-r]
----
...
[source]
----
include::{partialsdir}/ex-table-cell.adoc[tag=span-cr]
----
...
The alignment component for cells works the same as the xref:columns.adoc#cols-align[column specifier alignment component].

.Cells aligned horizontally, vertically, and across a span of three columns
[source]
----
include::{partialsdir}/ex-table-cell.adoc[tag=cell-align]
----
...
The xref:columns.adoc#cols-style[style component] can also be applied to individual cells.
...
[source]
----
include::{partialsdir}/ex-table-cell.adoc[tag=cell-ad]
----
...
....
include::{partialsdir}/ex-table-cell.adoc[tag=cell-src]
....
...
[source]
----
include::{partialsdir}/ex-table-cell.adoc[tag=cell-v]
----
