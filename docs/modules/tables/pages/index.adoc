...
Each row must share the same number of cells, taking into account any xref:cells.adoc#span[column or row spans].
...
[source]
----
include::{partialsdir}/ex-table.adoc[tag=base-co]
----
...
include::{partialsdir}/ex-table.adoc[tag=base-alt]
...
[source]
----
include::{partialsdir}/ex-table.adoc[tag=base-rolename]
----
