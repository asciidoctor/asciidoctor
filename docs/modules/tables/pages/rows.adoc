...
[source]
----
include::{partialsdir}/ex-table.adoc[tag=same]
----
...
The `*` is a repeat operator which is explained in xref:columns.adoc#cols-format[column specifiers].
...
[source]
----
include::{partialsdir}/ex-table.adoc[tag=same-indv]
----
...
[source]
----
include::{partialsdir}/ex-table.adoc[tag=opt-h]
----
...
[source]
----
include::{partialsdir}/ex-table.adoc[tag=impl-h]
----
...
[source]
----
include::{partialsdir}/ex-table.adoc[tag=opt-f]
----
