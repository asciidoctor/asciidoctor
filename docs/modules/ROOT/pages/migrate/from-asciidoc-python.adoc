...
|See xref:text:css-and-custom.adoc[custom text styles]
|===
...
|See xref:sections:level-and-title.adoc[section levels and titles]
...
|See xref:tables:column.adoc#cols-align[align column content] or xref:tables:column.adoc#align-cell[cell content].
...
|source
a|
* You can choose from a number of xref:source:source.adoc[syntax highlighters].
