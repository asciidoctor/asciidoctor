...
The requirements for a manual page (man page) are described in the xref:manpage:index.adoc[man page documentation].
...
See the xref:publish:static-website-generators.adoc[static website generators section] to learn how Asciidoctor integrates with static website generators.
****
