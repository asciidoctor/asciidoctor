...
[source]
----
include::{partialsdir}/ex-desc.adoc[tag=desc-base]
----
...
.HTML output
====
include::{partialsdir}/ex-desc.adoc[tag=desc-html]
====
...
[source]
----
include::{partialsdir}/ex-keyword.adoc[tag=key-base]
----

.HTML output
====
include::{partialsdir}/ex-keyword.adoc[tag=key-html]
====
...
The xref:publish:docinfo.adoc[docinfo file] section details what these files can contain and how to use them.
