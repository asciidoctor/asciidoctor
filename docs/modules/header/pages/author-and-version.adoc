...
[source]
----
include::{partialsdir}/ex-author.adoc[tag=base]
----
...
[source]
----
include::{partialsdir}/ex-author.adoc[tag=2-mid]
----
...
[source]
----
include::{partialsdir}/ex-author.adoc[tag=attr]
----
...
[source]
----
include::{partialsdir}/ex-author.adoc[tag=multi]
----
...
[source]
----
include::{partialsdir}/ex-rev.adoc[tag=base]
----
...
[source]
----
include::{partialsdir}/ex-rev.adoc[tag=attr]
----
