...
:apidoc-syntax-highlighter-base: https://www.rubydoc.info/github/asciidoctor/asciidoctor/Asciidoctor/SyntaxHighlighter/Base
:apidoc-syntax-highlighter-for: https://www.rubydoc.info/github/asciidoctor/asciidoctor/Asciidoctor/SyntaxHighlighter/Factory#for-instance_method
