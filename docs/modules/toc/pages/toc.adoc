...
[source]
----
include::{partialsdir}/toc-title.adoc[]
----
...
[source]
----
include::{partialsdir}/toc-level.adoc[]
----
...
See the xref:toc-ref.adoc[table-of-contents-summary] to find out which attributes are available to each backend.
