...
Until nested open blocks become part of the Asciidoc language (https://github.com/asciidoctor/asciidoctor/issues/1121), this is actually a useful extension for html.
