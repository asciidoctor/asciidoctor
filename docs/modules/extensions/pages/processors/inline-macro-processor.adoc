...
The second example shows an example recognizing RFC names and turning them into links.
...
Inline macros are recognized by means of a regular expression set up with the name, format, and match DSL methods.
...
[source,ruby]
----
include::example$rfc-link-extension-inline.rb[]
----
...
[source, ruby]
----
include::example$rfc-link-extension-inline-runner.sh[tag=runner]
----
...
[source,html]
----
include::example$rfc-link-extension-inline-out.html[]
----