...
WARNING: The <<Default stylesheet>> uses Google Fonts which is https://cookie-script.com/blog/google-fonts-and-gdpr[not GDPR compliant]. To avoid this issue you can <<Apply a Custom Stylesheet>>.
