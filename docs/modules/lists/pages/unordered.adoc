...
[source]
----
include::{examplesdir}/unordered.adoc[tag=base]
----
...
[source]
----
include::{examplesdir}/unordered.adoc[tag=base-t]
----
...
[source]
----
include::{examplesdir}/unordered.adoc[tag=base-alt]
----
...
[source]
----
include::{examplesdir}/unordered.adoc[tag=divide]
----
****
...
[source]
----
include::{examplesdir}/unordered.adoc[tag=nest]
----
...
[source]
----
include::{examplesdir}/unordered.adoc[tag=max]
----
...
== Custom markers
// Included in user-manual: Unordered lists: Custom markers
...
[source]
----
include::{examplesdir}/unordered.adoc[tag=square]
----
