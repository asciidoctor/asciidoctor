= Source Code Paragraphs and Blocks
...
// <<user-manual#doc-header,document header>>
...
....
include::{partialsdir}/ex-src.adoc[tag=src-base-co]
....
...
====
include::{partialsdir}/ex-src.adoc[tag=src-base-co-res]
====

.Source paragraph
[source]
----
include::{partialsdir}/ex-src.adoc[tag=src-para-co]
----
...
====
include::{partialsdir}/ex-src.adoc[tag=src-para]
====
...
....
include::{partialsdir}/ex-src.adoc[tag=src-lang]
....
...
....
include::{partialsdir}/ex-src.adoc[tag=src-inc]
....
...
//<<incremental-substitutions,incremental substitutions>>
