...
- {coderay-uri} is now {url-coderay}
- {coderay-gem} is now {url-coderay-gem}
////
...
See the xref:publish:html-code-styles.adoc#coderay[CodeRay stylesheet section] to learn about the `coderay-css` attribute.
