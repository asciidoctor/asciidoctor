...
////
From quote-alt.adoc, included in:
...
[source]
----
include::{partialsdir}/ex-quote.adoc[tag=para2-c]
----
...
====
include::{partialsdir}/ex-quote.adoc[tag=para2]
====
...
[source]
----
include::{partialsdir}/ex-quote.adoc[tag=comp]
----
...
[source]
----
include::{partialsdir}/ex-quote.adoc[tag=abbr]
----
...
[source]
----
include::{partialsdir}/ex-quote.adoc[tag=air]
----
...
[source,markdown]
----
include::{partialsdir}/ex-quote.adoc[tag=md]
----
...
....
include::{partialsdir}/ex-quote.adoc[tag=md-alt]
....
