...
[source]
----
include::{examplesdir}/id.adoc[tag=block-id-brackets]
----
...
[source]
----
include::{examplesdir}/id.adoc[tag=block-id-shorthand]
----
...
[source]
----
include::{examplesdir}/id.adoc[tag=anchor-brackets]
----
...
[source]
----
include::{examplesdir}/id.adoc[tag=anchor-shorthand]
----
...
[source]
----
include::{examplesdir}/id.adoc[tag=anchor-wrong]
----
...
[source]
----
include::{examplesdir}/id.adoc[tag=anchor-list]
----
...
[source]
----
include::{examplesdir}/id.adoc[tag=anchor-header]
----
...
[source]
----
include::{examplesdir}/id.adoc[tag=anchor-header-extra]
----
...
[source]
----
include::{examplesdir}/id.adoc[tag=anchor-xreflabel]
----
...
[source]
----
include::{examplesdir}/id.adoc[tag=anchor-macro]
----
