...
Enhancements::
  ...
  * added pygments as source highlighter option (#538)
  ...
  * added Markdown-style horizontal rules (w/ restriction) (#455)
...
Enhancements::
  ...
  * added section level 5 (maps to <h6> in html5 backend) (#334)
