...
Compliance::
  ...
  * Move style tag for client-side syntax highlighers (highlight.js, prettify) into head (#3503)
...
Improvements::
  ...
  * Use the asset directory attribute (ie. `imagesdir` or `iconsdir`) on the node to resolve the asset path from the target (#3661) (*@mogztter*)
