...
Enhancements::
  ...
  * allow table striping to be configured using stripe attribute or stripe roles on table; valid values are even, odd, all, and none (#1365, PR #2588)
  ...
  * parse and pass all manpage names to output document master (shadow man pages) (#1811, #2543, PR #2414)
...
Distribution Packages::
  ...
  * https://pkgs.alpinelinux.org/packages?name=asciidoctor[Alpine (asciidoctor)]
...
Improvements::
  ...
  * add warning in verbose mode if xref is not found (@fapdash) (#2268)
