...
Bug Fixes::
  ...
  * Only skip front matter of main document if skip-front-matter attribute is set (#3437)
  * Only skip front matter in include files if skip-front-matter option is set (#3437)
