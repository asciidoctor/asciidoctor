...
Enhancements::
  ...
  * BREAKING: drop XML tags, character refs, and non-word characters (except hyphen and space) when auto-generating section IDs (#794)
  ...
  * allow table striping to be configured using stripe attribute (even, odd, all, or none) or stripe roles on table (#1365, PR #2588)
