...
// QUESTION Maybe we can move this note with the explanation on why using linux packages is better than gem ?
...
// QUESTION Remove that part with "Once the Asciidoctor gem installed, you can invoke Asciidoctor from the CLI:"
...
// QUESTION Keep it short and add a "For more information..." ?
