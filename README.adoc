...
Asciidoctor works on Linux, macOS, Android and Windows and requires one of the following implementations of {url-ruby}[Ruby]:
...
https://github.com/gsantner/markor[Markor] is a Lightweight Markdown Text editor for android.
Since Version 2.11 Markor supports AsciiDoc with 

* SyntaxHighlighting and 
* HtmlPreview (with option to export as pdf file)

Markor uses the javascript for AutoDoc processing.

Is is available on https://f-droid.org/packages/net.gsantner.markor/[f-droid]
