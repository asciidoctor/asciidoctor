...
{uri-rel-file-base}README-zh_CN.adoc[Chinese]
|
{uri-rel-file-base}README-de.adoc[German]
|
{uri-rel-file-base}README-fr.adoc[French]
|
{uri-rel-file-base}README-ja.adoc[Japanese]
endif::[]
