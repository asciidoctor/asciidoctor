...
TIP: Votre système Fedora peut être configuré pour mettre à jour les paquets automatiquement, auquel cas aucune action de votre part ne sera nécessaire pour mettre à jour la gemme.
...
TIP: Votre système peut être configuré pour mettre à jour les paquets deb automatiquement, auquel cas aucune action de votre part ne sera nécessaire pour mettre à jour la gemme.
...
TIP: Votre système Alpine Linux peut être configuré pour mettre à jour les paquets automatiquement, auquel cas aucune action de votre part ne sera nécessaire pour mettre à jour la gemme.
