...
{uri-rel-file-base}README-zh_CN.adoc[Chinesischen]
|
{uri-rel-file-base}README.adoc[Englisch]
|
{uri-rel-file-base}README-fr.adoc[Französisch]
|
{uri-rel-file-base}README-ja.adoc[Japanisch]
endif::[]
