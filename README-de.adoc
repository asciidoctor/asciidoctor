...
Asciidoctor arbeitet unter Linux, MacOS, Android und Windows und benötigt eine der folgenden Implementierungen von {uri-ruby}[Ruby]:
...
https://github.com/gsantner/markor[Markor] ist ein Markdown Text Editor für Android.
Seit Version 2.11 unterstützt Markor das AsciiDoc Format mit

* SyntaxHighlighting und 
* Html-Vorschau (mit der Möglickeit zum export als pdf Datei)

Markor verwendet Javascript für die AutoDoc Verarbeitung.

Download via https://f-droid.org/packages/net.gsantner.markor/[f-droid]
