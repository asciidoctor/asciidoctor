...
* {uri-rel-file-base}README.adoc[英语]
* {uri-rel-file-base}README-de.adoc[德语]
* {uri-rel-file-base}README-fr.adoc[法语]
* {uri-rel-file-base}README-ja.adoc[日语]
...
使用包管理器（ apt ）安装的 Asciidoctor 的版本也许不是最新发布版。
